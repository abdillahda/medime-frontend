    ...
    <div className="p-8 h-full flex flex-col relative bg-gray-50">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Kelola data staf internal dan admin Medime</p>
        </div>
        <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-300 mt-1">Nantinya akan diisi daftar staf lab, analis, dan admin.</p>
        </div>
      </div>
      ...
      >
        <div className="p-6 border-b border-gray-100 flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-gray-500">Form pendaftaran akun staf internal baru</p>
          </div>
          <button
            onClick={() => setIsDrawerOpen(false)}
